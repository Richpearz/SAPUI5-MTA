		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#richpearzprojectfioriexp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"richpearzprojectfioriexp-display": {
								"semanticObject": "richpearzprojectfioriexp",
								"action": "display",
								"description": "Fiori Expert",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=richpearz.projectfioriexp",
									"url": sap.ui.require.toUrl("richpearz/projectfioriexp")
								}
							}
						}
					}
